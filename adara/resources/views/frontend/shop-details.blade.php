...
<head>
    ...
    <title>Super Cars online shop details page </title>
                                            ...
                                            <ul class="mega-menu">
                                                <li class="mega-menu-wrap">
                                                    <ul class="mega-menu-col">
                                                        ...
                                                        <li><a href="{{ route('shopSidebar.page') }}">Shop Sidebar
                                                                page </a></li>

                                                        <li><a href="{{ route('shop.page') }}">Our shop page</a></li>
                                                        <li class="active"><a href="#">Shop Details page </a>
                                                        </li>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Modern Cars</a></li>
                                    <li class="breadcrumb-item"><a href="shop.html">Expensive Cars</a></li>
                                    <li class="breadcrumb-item"><a href="shop.html">Gybrid Cars</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Tracker Cars</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <div class="shop-details-content">
                            ...
                            <form action="{{ $cart != null ? route('cart.page') : route('add.cart') }}"
                                method="{{ $cart != null ? 'GET' : 'POST' }}" class="rating">
                                @csrf
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="reviews" role="tabpanel"
                                    ...
                                    @foreach ($products->reviews as $review)
                                        <h3 class="p-0 m-0" style="color: blue ">{{ $review->client->fullname }}
                                        </h3>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="fullname"
                                                    ...
                                                    {{ $client != null ? 'hidden' : '' }} required>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="email" name="email" value="{{ $client->email }}"
                                                    placeholder="Your Email*" {{ $client != null ? 'hidden' : '' }}
                                                    required>
                                ...
                                <div class="new-arrival-item text-center">
                                    <div class="thumb mb-25">
                                        <a href="{{ route('main.show', $item->id) }}"><img
                                                src="{{ asset($item->image) }}" width="296" height="344"
                                                alt=""></a>
                        ...
                        <div class="footer-widget mb-50">
                            ...
                            <div class="fw-link">
                                <ul>
                                    ...
                                    <li><a href="shop-sidebar.html">Future Cars</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget mb-50">
                            ...
                            <div class="footer-text">
                                <p>Get Free Shipping on all your carts!</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="copyright-text">
                            <p>&copy; 2024 <a href="index.html">Adara</a>. All Rights Reserved | +998936420115</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
