...
<head>
    ...
    <title>Super Cars online shop | shop page</title>
...
<body>
                                                ...
                                                <li class="mega-menu-wrap">
                                                    <ul class="mega-menu-col">
                                                        <li class="mega-title"><a
                                                                href="{{ route('shop.page') }}">SHOP PAGES</a></li>

                                                        <li><a href="{{ route('shop.page') }}">Our shop page</a></li>
                                                        <li><a href="#">Shop Details page </a></li>
                                                        <li class="active"><a href="{{ route('cart.page') }}">Cart
                                                                Page</a></li>
                        ...
                        <div class="mobile-menu">
                            ...
                            <nav class="menu-box">
                                <div class="nav-logo"><a href="{{ route('main.page') }}"><img
                                            src="{{ $settings->full_bg_image }}" alt="" title=""></a>
                                </div>
    ...
    <main>
        ...
        <section class="breadcrumb-area breadcrumb-bg"
            data-background="{{ asset('frontend/assets/img/bg/image11.webp') }}">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb-content">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="main.page">Home</a></li>
                            ...
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="{{ route('main.show', $product->id) }}"><img
                                            src="{{ $product->image }}" width="296" height="344"
                                            alt=""></a>
                                ...
                                <div class="content">
                                    <h5><a href="{{ route('main.show', $product->id) }}">{{ $product->name }}</a>
                                    </h5>
