                                    ...
                                    <ul class="minicart">
                                        ...
                                        <li>
                                            <div class="checkout-link">
                                                ...
                                                <a class="black-color" href="{{ route('cart.page') }}">Checkout</a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div class="menu-wrap">
                            <nav class="menu-nav show">
                                ...
                                <div class="header-action d-none d-md-block">
                                    <ul>
                                        <li class="shipping-offer">Free Shipping on Orders <span>$399+</span></li>
                    ...
                    <div class="main-slider-nav">
                        @foreach ($offers as $offer)
                            <div class="slider-nav-item">
                                <img src="{{ asset($offer->image) }}" alt="" width="220">
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-12 col-sm-10">
                        <div class="cat-banner-item banner-animation mb-20">
                            <a href="/shop"><img src="{{ asset($settings->left_image) }}" width="850px"
                                    height="780px" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-10">
                                ...
                                <div class="cat-banner-item banner-animation mb-20">
                                    <div class="thumb">
                                        <a href="/shop"><img src="{{ asset($settings->top_right_image) }}"
                                                width="400" height="237" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <span>NEW COLLECTION</span>
                                        <h3><a href="/shop">FERRARI</a></h3>
                                        <a href="/shop" class="btn">TAKE IT</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="cat-banner-item style-two banner-animation mb-20">
                                    <div class="thumb">
                                        <a href="/shop"><img src="{{ asset($settings->bottom_image) }}"
                                                width="990" height="523" alt=""></a>
                                    </div>
                                    <div class="content">
                                        <span>NEW COLLECTION</span>
                                        <h3><a href="/shop">ROCKET 1000</a></h3>
                                        <a href="/shop" class="btn">FEEL IT</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="section-title text-center mb-25">
                            <h3 class="title">Future PRODUCTS</h3>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                                                    ...
                                                    <ul>
                                                        <li class="color-option">
                                                            @foreach ($product->colors as $color)
                                                                ...
                                                                <span
                                                                    style="height:18px; width:18px; border-radius:50%; background-color:{{ $color->colorItem ? $color->colorItem->color : '' }};"></span>
                                                            @endforeach
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="discount-content text-center">
                            <div class="icon mb-15"><img
                                    src="{{ asset('frontend/assets/img/icon/Money_icon.jpg') }}" width="110" height="100" alt="">
                            <span>{{ $settings->stock_name }}</span>
                            <h2>SPECIAL Collection End of Season Sale upto 30%</h2>
                    ...
                    <div class="col-12">
                        <div class="newsletter-bg"
                            ...
                            <div class="newsletter-title mb-65">
                                <h2 class="title" style="color: rgb(200, 212, 27)">NEWSLETTER!</h2>
                            ...
                            <form action="{{ route('regster.news') }}" method="POST" class="newsletter-form">
                                ...
                                <button type="password">
                                    <h4>Subscribe</h4> <i class="far fa-arrow-alt-circle-right"></i>
                                </button>
                    ...
                    @foreach ($ads as $item)
                        <div class="col">
                            <div class="insta-post-item">
                                <a href="https://t.me/lednik_warrior" target="_blank">
                    ...
                    <div class="col-12">
                        <div class="footer-logo">
                            <a href="{{ route('main.page') }}"><img
                                    src="{{ asset('frontend\assets/img/logo/shop_1.jpg') }}" width="300" height="200" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="copyright-text">
                            <p>&copy; 2024 <a href="/blog">Safo</a>. All Rights Reserved |+998936420115</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
