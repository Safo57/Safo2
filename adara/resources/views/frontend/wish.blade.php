                                            ...
                                            @foreach ($wishs as $wish)
                                                <tr>
                                                    ...
                                                    <td class="product-thumbnail"><a
                                                            href="{{ route('main.show', $wish->product_id) }}"><img
                                                                src="{{ asset($wish->image) }}" alt=""></a>
                                                    </td>
                                                    ...
                                                    <td class="product-price">
                                                        ...
                                                        <h6 style="color:green">
                                                            {{ $wish->price - $wish->price * ($wish->discount / 100) }}
                                                        </h6>
                                                    ...
                                                    <td class="product-delete">
                                                        <a class="mr-2"
                                                            href="{{ route('main.show', $wish->product_id) }}"><i
                                                                class="fa fa-eye"></i></a>
                                                        <a href="{{ route('delete.wish', $wish->id) }}"><i
                                                                class="flaticon-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
